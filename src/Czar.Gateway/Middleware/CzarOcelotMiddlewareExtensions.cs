...
namespace Czar.Gateway.Middleware
{
    ...
    /// </summary>
    public static class CzarOcelotMiddlewareExtensions
    {
        
        public static async Task<IApplicationBuilder> UseCzarOcelot(this IApplicationBuilder builder)
        {
            await builder.UseCzarOcelot(new OcelotPipelineConfiguration());
            return builder;
        }

        public static async Task<IApplicationBuilder> UseCzarOcelot(this IApplicationBuilder builder, Action<OcelotPipelineConfiguration> pipelineConfiguration)
        {
            var config = new OcelotPipelineConfiguration();
            pipelineConfiguration?.Invoke(config);
            return await builder.UseCzarOcelot(config);
        }
